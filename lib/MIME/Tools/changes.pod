...
=item Version 6.200_02   (2003/06/27)   

B<Added Charset to MIME::Entity::sign>.
I<Thanks to Honza Holec(ek for the suggestion.>

B<Fixed MIME::WordDecoder warnings about uninitialized value.>
I'm new to the whole "locale" thing, so I'm bound to get
this part wrong a few more times.
I<Thanks to Nigel Kukard et al for the bug report.>


=item Version 6.200_01   (2003/06/09)

B<Support for virtually any charset in MIME::WordDecoder.>
Enabled via Unicode::String and Unicode::Map, which means
you gotta get those now.
I<Thanks to Rafa Bielinski for the motivation.>


=item Version 6   (2003/05/25)
